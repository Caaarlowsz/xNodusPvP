...
public class Events implements Listener
{
    ...
    public void onDropSword(final PlayerDropItemEvent e) {
        if (e.getItemDrop().getItemStack().getType() == Material.STONE_SWORD || Main.usandokit.contains(e.getPlayer()) || e.getItemDrop().getItemStack().getType() == Material.STONE_SWORD || e.getItemDrop().getItemStack().getType() == Material.DIAMOND || e.getItemDrop().getItemStack().getType() == Material.DIAMOND || e.getItemDrop().getItemStack().getType() == Material.QUARTZ || e.getItemDrop().getItemStack().getType() == Material.WOOD_AXE || e.getItemDrop().getItemStack().getType() == Material.MILK_BUCKET || e.getItemDrop().getItemStack().getType() == Material.NETHER_STAR || e.getItemDrop().getItemStack().getType() == Material.APPLE || e.getItemDrop().getItemStack().getType() == Material.FISHING_ROD || e.getItemDrop().getItemStack().getType() == Material.STONE_SWORD || e.getItemDrop().getItemStack().getType() == Material.STICK || e.getItemDrop().getItemStack().getType() == Material.SADDLE || e.getItemDrop().getItemStack().getType() == Material.WOOD_HOE || e.getItemDrop().getItemStack().getType() == Material.MONSTER_EGG || e.getItemDrop().getItemStack().getType() == Material.GOLD_AXE || e.getItemDrop().getItemStack().getType() == Material.EYE_OF_ENDER || e.getItemDrop().getItemStack().getType() == Material.NETHER_FENCE || e.getItemDrop().getItemStack().getType() == Material.SUGAR || e.getItemDrop().getItemStack().getType() == Material.FLINT || e.getItemDrop().getItemStack().getType() == Material.REDSTONE_TORCH_ON || e.getItemDrop().getItemStack().getType() == Material.BEDROCK || e.getItemDrop().getItemStack().getType() == Material.LEASH || e.getItemDrop().getItemStack().getType() == Material.REDSTONE || e.getItemDrop().getItemStack().getType() == Material.ENCHANTED_BOOK || e.getItemDrop().getItemStack().getType() == Material.STONE_AXE || e.getItemDrop().getItemStack().getType() == Material.SNOW_BALL || e.getItemDrop().getItemStack().getType() == Material.SLIME_BALL || e.getItemDrop().getItemStack().getType() == Material.GOLD_INGOT || e.getItemDrop().getItemStack().getType() == Material.PORTAL || e.getItemDrop().getItemStack().getType() == Material.BLAZE_POWDER || e.getItemDrop().getItemStack().getType() == Material.POTION || e.getItemDrop().getItemStack().getType() == Material.BOW || e.getItemDrop().getItemStack().getType() == Material.ARROW || e.getItemDrop().getItemStack().getType() == Material.GOLDEN_APPLE || e.getItemDrop().getItemStack().getType() == Material.FIREWORK || e.getItemDrop().getItemStack().getType() == Material.EMERALD || e.getItemDrop().getItemStack().getType() == Material.CHEST || e.getItemDrop().getItemStack().getType() == Material.GOLD_NUGGET || e.getItemDrop().getItemStack().getType() == Material.BLAZE_ROD || e.getItemDrop().getItemStack().getType() == Material.BREAD || e.getItemDrop().getItemStack().getType() == Material.DRAGON_EGG || e.getItemDrop().getItemStack().getType() == Material.BONE || e.getItemDrop().getItemStack().getType() == Material.FEATHER || e.getItemDrop().getItemStack().getType() == Material.STRING || e.getItemDrop().getItemStack().getType() == Material.COMPASS || e.getItemDrop().getItemStack().getType() == Material.SPONGE || e.getItemDrop().getItemStack().getType() == Material.SKULL_ITEM || e.getItemDrop().getItemStack().getType() == Material.BLAZE_POWDER || e.getItemDrop().getItemStack().getType() == Material.WATCH || e.getItemDrop().getItemStack().getType() == Material.COAL_BLOCK || e.getItemDrop().getItemStack().getType() == Material.REDSTONE_BLOCK || e.getItemDrop().getItemStack().getType() == Material.LAPIS_BLOCK || e.getItemDrop().getItemStack().getType() == Material.ENDER_CHEST || e.getItemDrop().getItemStack().getType() == Material.BEACON || e.getItemDrop().getItemStack().getType() == Material.IRON_BARDING || e.getItemDrop().getItemStack().getType() == Material.GOLD_HOE || e.getItemDrop().getItemStack().getType() == Material.WOOD_HOE || e.getItemDrop().getItemStack().getType() == Material.MINECART || e.getItemDrop().getItemStack().getType() == Material.DIAMOND_BLOCK || e.getItemDrop().getItemStack().getType() == Material.DIAMOND_CHESTPLATE || e.getItemDrop().getItemStack().getType() == Material.DIAMOND_BOOTS || e.getItemDrop().getItemStack().getType() == Material.IRON_BOOTS || e.getItemDrop().getItemStack().getType() == Material.IRON_CHESTPLATE || e.getItemDrop().getItemStack().getType() == Material.OBSIDIAN || e.getItemDrop().getItemStack().getType() == Material.VINE || e.getItemDrop().getItemStack().getType() == Material.TNT || e.getItemDrop().getItemStack().getType() == Material.BOOK || e.getItemDrop().getItemStack().getType() == Material.ENDER_PORTAL || e.getItemDrop().getItemStack().getType() == Material.IRON_FENCE || e.getItemDrop().getItemStack().getType() == Material.STONE_BUTTON || e.getItemDrop().getItemStack().getType() == Material.WOOD_BUTTON || e.getItemDrop().getItemStack().getType() == Material.CARROT_ITEM || e.getItemDrop().getItemStack().getType() == Material.ARROW || e.getItemDrop().getItemStack().getType() == Material.WOOL || e.getItemDrop().getItemStack().getType() == Material.PAPER || e.getItemDrop().getItemStack().getType() == Material.DIAMOND_BLOCK || e.getItemDrop().getItemStack().getType() == Material.DIAMOND_SWORD) {
            e.setCancelled(true);
        }
    }
    ...
    public void onInteract1(final PlayerInteractEvent e) {
        ...
        tigelameta.setDisplayName(ChatColor.translateAlternateColorCodes('&', Events.plugin.getConfig().getString("nomedopote")));
    ...
    public void onPlayerCLickInventry1(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equalsIgnoreCase("§a§lStatus") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
        }
    }
    ...
    public void onPlayerCommandPreprocess(final PlayerCommandPreprocessEvent event) {
        if (!event.isCancelled()) {
            ...
            if (topic == null) {
                player.sendMessage(String.valueOf(ChatColor.translateAlternateColorCodes('&', Events.plugin.getConfig().getString("prefix"))) + ChatColor.translateAlternateColorCodes('&', Events.plugin.getConfig().getString("comandoinvalido")));
