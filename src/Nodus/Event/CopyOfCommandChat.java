            ...
            if (args.length > 0) {
                if (args.length == 1) {
                    if (args[0].equalsIgnoreCase("off")) {
                        ...
                        Bukkit.getServer().broadcastMessage(String.valueOf(ChatColor.RED.toString()) + "O chat foi desativado");
                        ...
                        CopyOfCommandChat.chat = true;
                        Bukkit.getServer().broadcastMessage(String.valueOf(ChatColor.GREEN.toString()) + "O chat foi Ativado");
