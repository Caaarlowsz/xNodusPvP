    ...
    public static void TeleportArenaRandom(final Player p) {
        ...
        switch (number) {
            case 0: {
                ...
                p.teleport(lobby);
                p.sendMessage(Main.getInstance().getConfig().getString("MensagemTeleportArena1").replaceAll("&", "§").replaceAll("%kit", Habilidade.getAbility(p)).replaceAll("%p", p.getName()));
                break;
            }
            case 1: {
                ...
                p.getPlayer().playSound(p.getLocation(), Sound.ZOMBIE_REMEDY, 5.0f, 5.0f);
                p.teleport(lobby2);
                p.sendMessage(Main.getInstance().getConfig().getString("MensagemTeleportArena2").replaceAll("&", "§").replaceAll("%kit", Habilidade.getAbility(p)).replaceAll("%p", p.getName()));
                break;
            }
            case 2: {
                ...
                p.getPlayer().playSound(p.getLocation(), Sound.ZOMBIE_REMEDY, 5.0f, 5.0f);
                p.teleport(lobby3);
                p.sendMessage(Main.getInstance().getConfig().getString("MensagemTeleportArena3").replaceAll("&", "§").replaceAll("%kit", Habilidade.getAbility(p)).replaceAll("%p", p.getName()));
                break;
            }
            case 3: {
            ...
            case 4: {
                ...
                p.getPlayer().playSound(p.getLocation(), Sound.ZOMBIE_REMEDY, 5.0f, 5.0f);
                p.teleport(lobby5);
                p.sendMessage(Main.getInstance().getConfig().getString("MensagemTeleportArena5").replaceAll("&", "§").replaceAll("%kit", Habilidade.getAbility(p)).replaceAll("%p", p.getName()));
                break;
            }
        }
    }
