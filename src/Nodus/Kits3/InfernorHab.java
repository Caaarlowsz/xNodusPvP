...
public class InfernorHab implements Listener
{
    ...
    public void OnInfernoKit(final PlayerInteractEntityEvent event) {
        ...
        if (event.getRightClicked() instanceof Player) {
            ...
            if (!InfernorHab.Infer.contains(p)) {
                ...
                if (i.getType() == Material.NETHER_FENCE && i.hasItemMeta() && i.getItemMeta().getDisplayName().equalsIgnoreCase("§4Infernor") && p.hasPermission("kit.infernor")) {
                    ...
                    if (InfernorHab.fighting.containsKey(p.getName()) || InfernorHab.fighting.containsKey(r.getName())) {
                    ...
                    this.id2 = Bukkit.getScheduler().scheduleSyncDelayedTask(this.plugin, (Runnable)new Runnable() {
                        @Override
                        public void run() {
                            if (InfernorHab.fighting.containsKey(p.getName()) && InfernorHab.fighting.get(p.getName()).equalsIgnoreCase(r.getName()) && InfernorHab.fighting.containsKey(r.getName())) {
                    ...
                    this.id1 = Bukkit.getScheduler().scheduleSyncDelayedTask(this.plugin, (Runnable)new Runnable() {
                        @Override
                        public void run() {
                            if (InfernorHab.fighting.containsKey(p.getName()) && InfernorHab.fighting.get(p.getName()).equalsIgnoreCase(r.getName()) && InfernorHab.fighting.containsKey(r.getName()) && InfernorHab.fighting.get(r.getName()).equalsIgnoreCase(p.getName())) {
    ...
    public void onPlyaerInteract(final PlayerInteractEvent e) {
        if (e.getAction() == Action.LEFT_CLICK_BLOCK && e.getClickedBlock().getType() == Material.STAINED_GLASS && e.getClickedBlock().getData() == DyeColor.RED.getData() && e.getPlayer().getGameMode() != GameMode.CREATIVE && InfernorHab.fighting.containsKey(e.getPlayer().getName())) {
            e.setCancelled(true);
    ...
    public void onBlockBreak(final BlockBreakEvent e) {
        if (e.getBlock().getType() == Material.STAINED_GLASS && e.getPlayer().getGameMode() != GameMode.CREATIVE && InfernorHab.fighting.containsKey(e.getPlayer().getName())) {
            e.setCancelled(true);
    ...
    public void onPlyaerInteract2(final PlayerInteractEvent e) {
        if (e.getAction() == Action.LEFT_CLICK_BLOCK && e.getClickedBlock().getType() == Material.NETHERRACK && e.getPlayer().getGameMode() != GameMode.CREATIVE && InfernorHab.fighting.containsKey(e.getPlayer().getName())) {
            e.setCancelled(true);
            e.getClickedBlock().setType(Material.BEDROCK);
            Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(this.plugin, (Runnable)new Runnable() {
                @Override
    ...
    public void onBlockBreak2(final BlockBreakEvent e) {
        if (e.getBlock().getType() == Material.NETHERRACK && e.getPlayer().getGameMode() != GameMode.CREATIVE && InfernorHab.fighting.containsKey(e.getPlayer().getName())) {
            e.setCancelled(true);
            e.getBlock().setType(Material.BEDROCK);
            Bukkit.getScheduler().scheduleSyncDelayedTask(this.plugin, (Runnable)new Runnable() {
                @Override
