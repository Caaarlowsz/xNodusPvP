...
public class Avatar implements Listener, CommandExecutor {
	...
	public void Trocar(final PlayerInteractEvent e) {
		...
		if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK
				...
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().getType() == Material.BEACON) {
			p.setItemInHand(AR);
			Main.Ferro2.add(p.getName());
		} else if (Main.Ferro2.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().equals((Object) AR)) {
			p.setItemInHand(Agua);
			Main.Ferro2.remove(p.getName());
			Main.AvatarH.add(p.getName());
		} else if (Main.AvatarH.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().equals((Object) Agua)) {
			p.setItemInHand(Terra);
			Main.AvatarH.remove(p.getName());
			Main.Terra2.add(p.getName());
		} else if (Main.Terra2.contains(p.getName()) && Main.Terra2.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().equals((Object) Terra)) {
			p.setItemInHand(Fogo);
			Main.Terra2.remove(p.getName());
			Main.Red2.add(p.getName());
		} else if (Main.Red2.contains(p.getName())
				&& (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().equals((Object) Fogo)) {
			p.setItemInHand(AR);
	...
	public void AvatarAr(final PlayerInteractEvent event) {
		...
		if (Main.Ferro2.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().getType() == Material.WOOL) {
			if (Main.SemPvP(p)) {
	...
	public void AvatarAr1(final PlayerInteractEvent event) {
		final Player p = event.getPlayer();
		if (Main.AvatarH.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().getType() == Material.LAPIS_BLOCK) {
			if (Main.SemPvP(p)) {
				event.setCancelled(true);
				if (!Main.Tempo.contains(p)) {
					Main.Tempo.add(p);
	...
	public void AvatarAr11(final PlayerInteractEvent event) {
		final Player p = event.getPlayer();
		if (Main.Red2.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().getType() == Material.REDSTONE_BLOCK) {
			if (Main.SemPvP(p)) {
				event.setCancelled(true);
				if (!Main.Tempo.contains(p)) {
					Main.Tempo.add(p);
	...
	public void AvatarTerra(final PlayerInteractEvent event) {
		final Player p = event.getPlayer();
		if (Main.Terra2.contains(p.getName())
				&& (event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK)
				&& Main.Avatar.contains(p.getName()) && p.getItemInHand().getType() == Material.GRASS) {
			if (Main.SemPvP(p)) {
				event.setCancelled(true);
				if (!Main.Tempo.contains(p)) {
					Main.Tempo.add(p);
